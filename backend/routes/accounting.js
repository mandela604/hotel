...
router.post('/pnl/income',          ctrl.addIncome);
router.put('/pnl/income/:id',       ctrl.updateIncome);
router.delete('/pnl/income/:id',    ctrl.deleteIncome);
router.post('/pnl/expense',         ctrl.addExpense);
router.put('/pnl/expense/:id',      ctrl.updateExpense);
router.delete('/pnl/expense/:id',   ctrl.deleteExpense);
