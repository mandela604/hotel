...
const productionSchema = new mongoose.Schema({
  ...
  expectedYieldUnit: { type: String, default: 'portions' },
  outputQty:         { type: Number, default: 0 },
  outputUnit:        { type: String, default: 'portions' },
  ...
  dishes:            [{
    ...
    outputUnit:        { type: String, default: 'portions' },
    yieldVariancePct:  { type: Number, default: 0 },
    ingredients:       [{ name: String, qty: Number, unit: String, stockId: String, cost: Number }],
    cost:              { type: Number, default: 0 },
    status:            { type: String, enum: ['pending', 'in-progress', 'completed', 'voided'], default: 'in-progress' },
