...
exports.pnl = asyncHandler(async (req, res) => {
  ...
  const [roomIncome, restIncome, poolIncome, cooIncome, gymIncome, manualIncome, expenses, prs] = await Promise.all([
    ...
    safeAgg(() => aggregateOutletRevenue(from, to, 'Kitchen COO', 'Restaurant'), 'Kitchen COO Revenue'),
  ...
  const incomeRows = [...roomIncome, ...restIncome, ...poolIncome, ...cooIncome, ...gymIncome, ...manualIncome.map(e => ({
