...
(function (global) {
  ...
  function create(opts) {
    ...
    root.innerHTML =
      '<div class="bkm-modal" role="dialog" aria-modal="true">' +
        ...
        '<div class="bkm-foot">' +
          ...
          '<button type="button" class="bkm-btn bkm-btn-outline" data-act="printBooking"><i class="fa-solid fa-print"></i> Print</button>' +
    ...
    function findGuestForBooking(bk) {
      if (!bk) return null;
      if (bk.guestId) {
        var byId = (guests || []).find(function (g) { return g.id === bk.guestId || g.guestId === bk.guestId; });
        if (byId) return byId;
      }
