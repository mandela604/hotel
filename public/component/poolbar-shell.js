...
(function (global) {
  ...
  .pbs-navlabel{ font-size:9px; letter-spacing:2.5px; text-transform:uppercase; color:var(--text3); padding:18px 16px 6px; }
    .pbs-nav{ flex:1; overflow-y:auto; padding:4px 10px; scrollbar-width:none; -ms-overflow-style:none; }
    .pbs-nav::-webkit-scrollbar{ width:0; height:0; }
  ...
  .pbs-logout{ width:36px; height:36px; background:#ffffff; border:1px solid #eef0f6; border-radius:var(--radius-sm);
  ...
  .pbs-logout:hover{ background:#feecec; color:#f04438; border-color:rgba(240,68,56,.3); }
  ...
  function attach(opts) {
    ...
    topbarTarget.innerHTML = `
      <div id="pbs-topbar">
        ...
        <div class="pbs-topright">
          ...
          <button class="pbs-logout" id="pbs-logout" title="Log out"><i class="fa-solid fa-right-from-bracket"></i></button>
    ...
    document.getElementById('pbs-logout').addEventListener('click', async () => {
